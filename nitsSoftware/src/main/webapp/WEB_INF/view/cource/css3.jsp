...
<div class="container">
       <h2>CSS Classes In Pune</h2>
       <ol>
       <li><a href="/">Home</a></li>
         <li>css Classes In Pune</li>
       </ol>
     </div>
...
<div class="hadoopcontent col-md-8 ">
   <div class="ImageDiv"><img src="/assets/img/courses/CSS3.jpg" alt=""></div>
   <!-- <img src="assets/img/CSS3" alt=""> -->
   <div class="Image-content">
       <h3>CSS3 Training course In Pune</h3>
      ...
      <p> CSS is designed to enable the separation of presentation and content, 
       including layout, colors, and fonts.This separation can improve content
        ...
        specifying the relevant CSS in a separate .. CSS developers are web professionals
         whose primary responsibility is to deliver a polished and styled product to the visitor's 
         browser. Practically every website uses CSS, but CSS is often not considered an "equal" in the
          modern web development stack. Unfortunately, this misperception can lead to CSS being taken for 
          granted, or even overlooked to some extent. Allowing non-CSS developers to deal with CSS often
           results in the introduction of CSS hacks and bugs in your code, and can cause unnecessary frustration 
           for developers. In this article, I would like to familiarize everyone with what the job encompasses 
           so you can get a better understanding of why every site needs a reliable, professional CSS developer.</p>
           
   </div>
                  <div class='applications_css'>
                       <h4>Why Do People Need a CSS Developer?</h4>
                       
                           <p>
                           Most frontend or even full-stack developers could write the CSS code.
                            But not every one of them could fix every CSS bug or implement the design 
                            without convoluting HTML code or relying on JavaScript where it is not necessary. A professional CSS developer cares about the code to the final details, enjoys creating layouts and components, even the most complicated ones, and knows how to solve every problem or a bug.
                           </p>
   ...
   <div class="highlights">
                  ...
                  <div class="Syllabus">
                       ...
                       <div class='row'>
                           ...
                           <div class="col-md-4 syllabus_title1">
                               ...
                               <h5>CSS Basics.</h5>
                                   <ul>
                                       <li  class='listed_icons'>
                                           ...
                                           <span class="check_icon_list_text">CSS Transitions</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                           <span class="check_icon_list_text">Transition-delay</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                           <span class="check_icon_list_text">Transition-duration</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                           <span class="check_icon_list_text">Transition-property</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                           <span class="check_icon_list_text">Transitions-timing-function@keyframes Rule</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                           <span class="check_icon_list_text">sAnimation Property</span>
                                       </li>
                                   </ul>
                               </div>
