...
<div class="container">
        <h2>Best Android Development Classes In Pune</h2>
        <ol>
        <li><a href="/">Home</a></li>
          <li>Android Development Classes In Pune</li>
        </ol>
      </div>
...
<div class="hadoopcontent col-md-8 ">
    <div class="ImageDiv"><img src="/assets/img/courses/Android-1.jpg" alt="Android"></div>
    <!-- <img src="assets/img/CSS3" alt=""> -->
    <div class="Image-content">
        <h3>Android Development Course & Certification In Pune</h3>

       <p>Learning Android app development is easy for those having essential knowledge of Core Java. If you have the ability to study industry problems and think logically for the solution, you can easily grow your career in Android app development.We are living in era of smart phone, to be precise Android phone. If you have decided to pursue Android Application Development Training it will be most smart decision to initiate your IT Software career. Android is open source OS and Android Development Tool is also open source (it is free of cost). To build an App using these tools is easy and cost effective. Now a days Android Development is in demand and widely used in world. Scope wise it is best choice because in India it is started just few years ago and there is way more to go.</p>
                ...
                <div class='applications_css'>
                        <h4>What is Android development?</h4>
                            ...
                            <p>Tap into extensive APIs to overcome mobile device limitations</p>
                            <p>Incorporate services that enhance the user experience and increase runtime efficiency</p>
                            <p>Access free resources to accelerate android development and improve results</p>

                            <p>Thinking about developing a new Android app? You're in good company. Since launching in 2003 as an open source project based on the Linux kernel, Android has become the world's most popular mobile operating system. Android currently runs on over two billion devices worldwide, and developers have published nearly four million apps. Many of the major manufacturers use Android on their phones, including HTC, Huawei, Lenovo, LG, Samsung, and Sony. </p>
                       
                            <p>Whether or not you have prior Android development experience, you know that preparation can make a big difference in the success of your project. Having the right information and resources helps ensure a smooth start and an efficient, productive process.</p>
    ...
    <div class="highlights">
                   ...
                   <div class="Syllabus">
                       ...
                       <h5>Anroid Advanced Complete course.</h5>
                        <div class="col-md-15 syllabus_title1">
                           ...
                           <h5>Introduction To Android</h5>
                               ...
                               <ul>
                                   <li  class='listed_icons'>
                                       ...
                                       <span class="check_icon_list_text">Basic views and</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Java Basics</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Layout and Media</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Theme Demo</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Linear Layout</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">video View</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Activity and Parsing data</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">ListView and recyclerview</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Google news appSolite database</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Firebase</span>
                                   </li>
                               </ul>
                           </div>
                           ...
                           <h5>Whatsapp</h5>
                               ...
                               <ul style="margin-top: 20px ">
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Firebase Authentication part 1&part 2</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">ViewPager</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Adding Users and Uploading Profile Pic</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Autologin and Profile Pic Settings</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Displaying Users</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Message Activity</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Sending Message</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Displaying Messages.</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">showing users with we have some chat</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">User Online , offline.</span>
                                   </li>
                                   <li  class='listed_icons'>
                                       <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"></i></span>
                                       <span class="check_icon_list_text">Video calling</span>
                                   </li>
                               </ul>
                           </div>
