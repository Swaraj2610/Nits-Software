...
<div class="container">
       <h2>Best Angular Classes  In Pune</h2>
       <ol>
       <li><a href="/">Home</a></li>
         <li>Angular Course In Pune</li>
       </ol>
     </div>
...
<div class="hadoopcontent col-md-8 ">
   <div class="ImageDiv"><img src="/assets/img/courses/Angular.jpg" alt="angular"></div>
   <!-- <img src="assets/img/CSS3" alt=""> -->
   <div class="Image-content">
       <h3>Angular Classes In Pune</h3>
      <p>AngularJS is a JavaScript-based open-source front-end web framework for developing single-page applications. Angular is an open-source, JavaScript framework written in TypeScript. Google maintains it, and its primary purpose is to develop single-page applications. As a framework, Angular has clear advantages while also providing a standard structure for developers to work with. It enables users to create large applications in a maintainable manner.</p>
               ...
               <div class='applications_css'>
                       <h4>Why Angular?</h4>
                           ...
                           <p>These days, we have a variety of frameworks and libraries designed to provide alternative solutions. With respect to front-end web development, Angular addresses many, if not all, of the issues developers face when using JavaScript on its own.</p>
                            ...
                            <h5><p><b>Why Do People Need a Framework?</b></p></h5>
   ...
   <div class="Image-content2">
       <h6>NITS SOFTWARES is one of the best Angular Training institute in Pune. All the Trainers are Java certified and working experienced trainers.</h6>
   <div class="listing">
       <div>
           <ul>
   ...
   <div class="highlights">
                  ...
                  <div class="Syllabus">
                      ...
                      <h5>Angular JS Advanced Complete course.</h5>
                       <div class="col-md-15 syllabus_title1">
                          
                           
                          <div class='list_developer_do'>
                          <h5>Introduction To Angular JS</h5>
                              ...
                              <ul >
                               <!-- <li><i class="fa-solid fa-check"style="color: orange"  style="color: orange;"></i>Struts2 – Basic MVC Architecture</li> -->
                                  ...
                                  <li  class='listed_icons'>
                                      ...
                                      <span class="check_icon_list_text">Environment setup</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">MVC Architecture</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Tables and Filters</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Directives</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Expression</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">HTML DOM</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Modules</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Forms</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Includes</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">AJAX</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Views</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Scopes</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Services</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Dependency Injection</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">ACustom Directives</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Internationalization</span>
                                  </li>
                          ...
                          <div class='list_developer_do'>
                          <h5>Angular JS Applicatiion</h5>
                          
                              <ul style="margin-top: 20px ">
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">To Do Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Notepad Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Bootstrap Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Login Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Upload File</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">In-line Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Nav Menu</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Switch Menu</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Order Form</span>
                                  </li>

                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Search Tab</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Drag Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Cart Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Translate Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Chart Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Share Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Weather Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Timer Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Leaflet Application</span>
                                  </li>
                                  <li  class='listed_icons'>
                                      <span class='check_icon'><i aria-hidden="true" class="fa-solid fa-check"style="color: orange"></i></span>
                                      <span class="check_icon_list_text">Lastfm Application</span>
                                  </li>
