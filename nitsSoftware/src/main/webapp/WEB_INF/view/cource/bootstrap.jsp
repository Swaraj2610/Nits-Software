...
<div class="container">
       <h2>Bootstrap Classes In Pune</h2>
       <ol>
       <li><a href="/">Home</a></li>
         <li>Bootstrap Classes In Pune</li>
       </ol>
     </div>
      ...
      <p>Bootstrap is the most popular HTML, CSS, and JavaScript framework for developing responsive, mobile-first websites. Bootstrap is a free front-end framework for faster and easier web development. Bootstrap includes HTML and CSS based design templates for typography, forms, buttons, tables, navigation, modals, image carousels and many other, as well as optional JavaScript plugins.</p>
               ...
               <div class='applications_css'>
                       <h4>What Is Bootstrap?</h4>
                           ...
                           <p>
                           Bootstrap is a free and open-source web development framework. It's designed to ease the web development process of responsive, mobile-first websites by providing a collection of syntax for template designs. In other words, Bootstrap helps web developers build websites faster as they don’t need to worry about basic commands and functions. It consists of HTML, CSS, and JS-based scripts for various web design-related functions and components. This article will cover the benefits of using Bootstrap and explain the different file types it uses. By the end, you will know whether Bootstrap can benefit your workflow
                           </p>
                           <p><b>Why Bootstrap?</b></p>
                           <p>Bootstrap is the go-to toolkit for many front-end developers. According to W3Techs, it's used by 22.1% of all websites on the internet. There are a few factors driving Bootstrap’s popularity. First and foremost, it’s open-source and therefore free to download and use. It’s also fully customizable, and compatible with all modern browsers. This is true of many CSS frameworks, however. What sets Bootstrap apart from other development toolkits is that it was developed mobile-first. Meaning, the code was optimized for mobile devices (i.e. the smallest screen size) first and then scaled up to display on larger screens. </p>
                               ...
                               <h5>Introduction To Bootstrap</h5>
                                   ...
                                   <ul >
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Installing Bootstrap</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true"></i></span>
                                           <span class="check_icon_list_text">Navigation bar</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Craeting our new project</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Grid layout system</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Creating grids in our project</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Containers in bootstrap</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Bootstrap Buttons & Font Awesome</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Jumberton buttons</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Bootstrap tables</span>
                                       </li>
                                       
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Bootstrap Cards</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">The CSS Z-Index and Stacking Order</span>
                                       </li>
                                       <li  class='listed_icons'>
                                           <span class='check_icon'><i aria-hidden="true" ></i></span>
                                           <span class="check_icon_list_text">Media Query Breakpoints</span>
                                       </li>
